...
- The project-local drift rail is `scripts/check-openspec-review-gates.rs`. It keeps sanitized fixtures, diagnostics, and guidance aligned; update it together with Cairn authoring guidance when adding new repeated omission classes.
