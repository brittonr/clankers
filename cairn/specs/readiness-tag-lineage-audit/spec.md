# Readiness Tag Lineage Audit Specification

## Purpose

Defines the `readiness-tag-lineage-audit` capability: documentation and deterministic contract coverage that records nearby internal readiness tags, their exact target commits, and evidence boundaries without moving existing tags.
