...
- [x] I2 [serial] r[openspec-review-gates.spec-stage-omission-prevention.strong-constraint-spec] Add `missing-strong-constraint-spec` to the focused review-gate checker for sanitized strong lifecycle constraints that are omitted or weakened in delta specs.
- [x] I3 [parallel] r[openspec-review-gates.spec-stage-omission-prevention.strong-constraint-spec] Add a negative sanitized fixture where proposal/design require generated artifact hygiene, required local verification, or a forbidden delivery path while the delta spec omits or weakens the constraint.
