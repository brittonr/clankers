...
- Use `scripts/check-openspec-review-gates.rs` and its fixture tree as the first implementation surface because Clankers owns the observed category vocabulary and repo-local examples.
