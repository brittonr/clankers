...
- [x] [serial] V2: Add or update source-boundary rails rejecting concrete DB/hook/TUI/protocol/root imports in reusable tool-host context modules. r[neutral-tool-service-context.verification.boundary-rail] [covers=neutral-tool-service-context.verification.boundary-rail] [evidence=cairn/changes/neutral-tool-service-context/evidence/boundary-rail.md]
