...
- [x] [serial] I6: Remove the `clankers-model-selection` concrete dependency from `clankers-agent` by injecting neutral routing and cost recorder services from the root app edge. r[remaining-coupling-drain.agent-concrete-ports.host-injected-services] [covers=remaining-coupling-drain.agent-concrete-ports.host-injected-services] [evidence=cairn/changes/drain-agent-concrete-ports/evidence/agent-model-selection-dependency-drain.md]
...
- [x] [serial] V5: Validate the `clankers-model-selection` dependency drain with affected cargo checks, focused agent/root tests, model-selection tests, lego dependency ownership, and workspace layering rails. r[remaining-coupling-drain.agent-concrete-ports.validation] [covers=remaining-coupling-drain.agent-concrete-ports.validation] [evidence=cairn/changes/drain-agent-concrete-ports/evidence/agent-model-selection-dependency-drain.md]
