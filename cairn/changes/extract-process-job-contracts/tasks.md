...
- [ ] [serial] I3: Move remaining profile/receipt/redaction/retention/notification DTOs behind the chosen owner and leave root/backend code as adapters. r[remaining-coupling-drain.process-job-policy.neutral-contract-owner] [covers=remaining-coupling-drain.process-job-policy.neutral-contract-owner] [evidence=evidence/process-job-contracts.md]
- [x] [serial] I4: Refresh runtime facade and embedded SDK inventories for the migrated admission contract. r[remaining-coupling-drain.process-job-policy.neutral-contract-owner] [covers=remaining-coupling-drain.process-job-policy.neutral-contract-owner] [evidence=evidence/process-job-contracts.md]
