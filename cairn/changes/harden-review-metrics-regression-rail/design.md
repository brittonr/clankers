...
- Replacing Cairn/OpenSpec generic gate internals.
...
**Rationale:** Metrics explain priority, but fixtures are what prevent regressions. Keeping enforcement in `scripts/fixtures/openspec-review-gates/**` avoids hidden dependency on local metrics logs.
...
**Choice:** Extend `scripts/check-openspec-review-gates.rs` before changing upstream Cairn/OpenSpec core.
