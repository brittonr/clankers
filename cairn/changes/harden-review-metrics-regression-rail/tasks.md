...
- [x] [serial] S1: Preserve a sanitized metrics snapshot for the repeated omission/incoherence classes driving this rail [r[openspec-review-gates.review-metrics-regression-rail.snapshot-selects-category]] [evidence=evidence/metrics-snapshot-2026-05-23.md]
- [x] [serial] S2: Define the metrics-regression delta spec, design, and verification plan before touching checker behavior [r[openspec-review-gates.review-metrics-regression-rail.secret-free-evidence]]
