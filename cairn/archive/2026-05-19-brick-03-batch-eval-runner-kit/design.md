...
Evidence anchors: src/modes/batch.rs; docs/src/getting-started/quickstart.md; docs/src/reference/request-lifecycle.md.

## Goals / Non-Goals

**Goals:**
- Make `batch-eval-runner-kit` copyable, inspectable, and testable as a small brick.
...
**Choice:** Implement the smallest recipe, manifest, policy, generated inventory, or receipt validator that proves `batch-eval-runner-kit`.
...
- `openspec validate brick-03-batch-eval-runner-kit --strict --json`
- Focused Rust test/example/checker for `batch-eval-runner-kit`
- `git diff --check`
