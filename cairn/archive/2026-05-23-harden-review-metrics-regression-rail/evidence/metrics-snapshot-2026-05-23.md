...
1. `omission|tasks|auto-fix` — count `491`
   - Sources: `cairn-gate=488`, `done-review=3`
...
3. `omission|tasks|prompt` — count `132`
   - Sources: `cairn-gate=125`, `done-review=7`
...
6. `omission|tasks|human` — count `36`
   - Sources: `cairn-gate=29`, `done-review=7`
...
7. `incoherent|tasks|prompt` — count `28`
   - Sources: `cairn-gate=26`, `done-review=2`
