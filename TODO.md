...
- [ ] **Session Forking** — Branch conversations to explore alternatives: `/fork`, `/rewind`, `/branches`, `/switch`, `/label` commands implemented (phases 1-4 ✅), branch panel TUI (phase 5 ✅). Remaining: branch details view, branch switcher, comparison/merge UI. (`openspec/changes/session-forking/`)
