...
- [ ] **Session Forking** — Branch conversations to explore alternatives: `/fork`, `/rewind`, `/branches`, `/switch`, `/label`, `/compare` commands (phases 1-8 ✅). Branch panel, switcher overlay, comparison view all done. Remaining: merge, cherry-pick, keyboard shortcuts polish, edge cases, docs. (`openspec/changes/session-forking/`)
