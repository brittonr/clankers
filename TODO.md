...
- [ ] **Session Forking** — Branch conversations to explore alternatives: `/fork`, `/rewind`, `/branches`, `/switch`, `/label` commands implemented (phases 1-3 ✅). Remaining: branch indicators in message view, branch panel TUI, branch comparison/merge UI. (`openspec/changes/session-forking/`)
