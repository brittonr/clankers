...
- [ ] [depends:effect-model] Add host-owned handlers for allow, deny, simulate, and replay modes for an initial file/shell/network/secret/tool subset. [covers=effect-ability-runtime.handlers]
