...
- [x] [depends:handlers] Route selected existing tool dispatch paths through effect handlers while preserving user-visible tool names and receipts. [covers=effect-ability-runtime.tool-dispatch] ✅ 1m 24s (started: 2026-05-16T23:41:57Z → completed: 2026-05-16T23:43:21Z; evidence: `cargo test -p clankers-runtime`)
- [x] [depends:handlers] Add fail-closed sentinels for absent/denied handlers before filesystem, process, socket, browser, provider, or secret side effects. [covers=effect-ability-runtime.fail-closed] ✅ 1m 23s (started: 2026-05-16T23:52:25Z → completed: 2026-05-16T23:53:48Z; evidence: `cargo test -p clankers-runtime fail_closed -- --nocapture`; `cargo test -p clankers-runtime`)
...
- [x] [depends:remote-deps] Implement safe missing-artifact sync and unsupported/missing/secret dependency failures. [covers=effect-ability-runtime.remote-sync] ✅ 1m 40s (started: 2026-05-16T23:56:31Z → completed: 2026-05-16T23:58:11Z; evidence: `cargo test -p clankers-runtime remote_dependency_sync -- --nocapture`; `cargo test -p clankers-runtime`)
- [x] [serial] Run effect handler matrix tests, remote dependency sync tests, and catalog parity subset. [covers=effect-ability-runtime.validation] ✅ 32s (started: 2026-05-16T23:58:33Z → completed: 2026-05-16T23:59:05Z; evidence: `openspec validate add-effect-ability-runtime --strict --json`; `cargo test -p clankers-runtime effects -- --nocapture`; `cargo test -p clankers-runtime effect_class -- --nocapture`; `cargo test -p clankers-runtime`)
