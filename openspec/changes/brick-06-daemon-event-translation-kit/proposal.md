...
- Define `daemon-event-translation-kit` as a reusable brick with explicit boundaries, fixtures, and verification evidence.
...
### New Capabilities
- `daemon-event-translation`: Daemon Event Translation Kit as a composable product-facing brick.
...
- **Testing**: Validate this change with `openspec validate brick-06-daemon-event-translation-kit --strict --json`, the focused recipe/checker, `git diff --check`, and any affected acceptance rail.
