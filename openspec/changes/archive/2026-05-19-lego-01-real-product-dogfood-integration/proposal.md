# Real product dogfood integration

## Why

Prove the green embedded SDK surface inside one real product-style integration before adding more generic SDK API.

## What Changes

The change defines a product dogfood manifest, deterministic boundary check, sanitized runtime transcript, and BLAKE3 receipt that prove a selected product composes only green SDK crates for in-process embedding.
