...
- [x] Inventory current `browser-automation` code/docs seams and record the exact files to touch.
...
- [x] Sync the delta spec into the canonical `browser-automation` spec and archive the change after implementation tasks complete.
