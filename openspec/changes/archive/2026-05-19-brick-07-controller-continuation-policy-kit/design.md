...
Evidence anchors: crates/clankers-controller/src/lib.rs; crates/clankers-controller/src/auto_test.rs.

## Goals / Non-Goals

**Goals:**
- Make `controller-continuation-policy-kit` copyable, inspectable, and testable as a small brick.
...
**Choice:** Implement the smallest recipe, manifest, policy, generated inventory, or receipt validator that proves `controller-continuation-policy-kit`.
...
- `openspec validate brick-07-controller-continuation-policy-kit --strict --json`
- Focused Rust test/example/checker for `controller-continuation-policy-kit`
- `git diff --check`
