...
- Define `self-evolution-receipt-chain-kit` as a reusable brick with explicit boundaries, fixtures, and verification evidence.
...
### New Capabilities
- `self-evolution-control`: Self-Evolution Receipt Chain Kit as a composable product-facing brick.
...
- **Testing**: Validate this change with `openspec validate brick-09-self-evolution-receipt-chain-kit --strict --json`, the focused recipe/checker, `git diff --check`, and any affected acceptance rail.
