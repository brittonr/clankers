...
- [ ] Inventory current `checkpoints-rollback` code/docs seams and record the exact files to touch.
...
- [ ] Run `git diff --check`.
- [ ] Sync the delta spec into the canonical `checkpoints-rollback` spec and archive the change after implementation tasks complete.
