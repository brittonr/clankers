...
- [ ] Inventory current `acp-ide-integration` code/docs seams and record the exact files to touch.
...
- [ ] Run `git diff --check`.
- [ ] Sync the delta spec into the canonical `acp-ide-integration` spec and archive the change after implementation tasks complete.
