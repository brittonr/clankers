...
- [x] [depends:pure-cache] Add side-effect and invalidation tests covering changed inputs, hidden env denial, network/shell denial, and cache hit receipts. [covers=content-addressed-agent-artifacts.cache-rails] ✅ 56s (started: 2026-05-16T23:28:23Z → completed: 2026-05-16T23:29:19Z; evidence: `cargo test -p clankers-artifacts`)
- [x] [serial] Run focused artifact-store tests, replay tests, and `cargo nextest run` subset; record acceptance receipts. [covers=content-addressed-agent-artifacts.validation] ✅ 2m 24s (started: 2026-05-16T23:29:40Z → completed: 2026-05-16T23:32:04Z; evidence: `openspec validate add-content-addressed-agent-artifacts --strict --json`; `cargo test -p clankers-artifacts artifact_store`; `cargo test -p clankers --lib replay`; `cargo nextest run -p clankers-artifacts`)
