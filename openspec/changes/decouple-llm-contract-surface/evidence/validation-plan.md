...
Replace this plan with machine-produced validation logs after implementation. Expected commands include focused engine/message/provider compatibility tests, Clankers agent adapter tests, the cargo-tree dependency rail, and the FCIS shell-boundary test.
