...
Define the reusable prompt assembly boundary for embedded and desktop Clankers hosts, including explicit host context, optional Clankers discovery policy, safe provenance, and context-reference controls.
