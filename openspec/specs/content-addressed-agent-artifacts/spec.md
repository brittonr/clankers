...
#### Scenario: hash identifies normalized artifact content r[content-addressed-agent-artifacts.identity.normalized-content]
...
#### Scenario: semantic changes alter the hash r[content-addressed-agent-artifacts.identity.semantic-change]
...
#### Scenario: unsupported fields are rejected or explicitly excluded r[content-addressed-agent-artifacts.canonicalization.exclusions]
...
#### Scenario: name update does not mutate stored artifact r[content-addressed-agent-artifacts.store.name-pointer]
...
#### Scenario: replay resolves original artifacts r[content-addressed-agent-artifacts.receipts.replay]
...
#### Scenario: inspect output stays redacted r[content-addressed-agent-artifacts.receipts.redaction]
...
#### Scenario: deterministic cache hit r[content-addressed-agent-artifacts.pure-cache.hit]
...
#### Scenario: hidden effect blocks cache use r[content-addressed-agent-artifacts.pure-cache.hidden-effect-denied]
