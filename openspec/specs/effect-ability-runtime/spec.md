...
#### Scenario: effect request carries policy-relevant metadata
r[effect-ability-runtime.effect-classes.metadata]
...
#### Scenario: enabling one pack enables only mapped effects
r[effect-ability-runtime.catalog-mapping.no-expansion]
...
#### Scenario: routed tool preserves public name
r[effect-ability-runtime.tool-dispatch.public-name]
...
#### Scenario: hash mismatch aborts execution
r[effect-ability-runtime.remote-sync.hash-mismatch]
