...
fn convert_messages(messages: &[clanker_message::transcript::AgentMessage]) -> Vec<ApiMessage> {
...
fn convert_content_block(content: &clanker_message::Content) -> ApiContentBlock {
