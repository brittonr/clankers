...
use super::actions::{Action, CoreAction, ExtendedAction};
...
fn common_normal() -> HashMap<KeyCombo, Action> {
    use CoreAction::{Cancel, EnterCommand, EnterInsert, PasteImage, Quit, ScrollPageDown, ScrollPageUp, Unfocus};
...
fn helix_normal_nav() -> HashMap<KeyCombo, Action> {
    use CoreAction::{FocusNextBlock, FocusPrevBlock, ScrollPageDown, ScrollPageUp, ScrollToBottom, ScrollToTop};
    use ExtendedAction as EA;
...
fn common_insert() -> HashMap<KeyCombo, Action> {
    use CoreAction::{Cancel, DeleteBack, DeleteForward, EnterNormal, HistoryDown, HistoryUp, MenuAccept, MenuDown, MenuUp, MoveEnd, MoveHome, MoveLeft, MoveRight, NewLine, PasteImage, Quit, ScrollDown, ScrollPageDown, ScrollPageUp, ScrollToBottom, ScrollToTop, ScrollUp, Submit};
    use ExtendedAction as EA;
...
fn readline_shortcuts() -> HashMap<KeyCombo, Action> {
    use CoreAction::{ClearLine, DeleteWord, MoveEnd, MoveHome};
