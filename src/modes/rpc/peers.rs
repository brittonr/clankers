...
pub fn peer_info_views(registry: &PeerRegistry) -> Vec<clanker_tui_types::PeerInfoView> {
    registry
        .list()
        .into_iter()
        .map(|p| clanker_tui_types::PeerInfoView {
            name: p.name.clone(),
            node_id: p.node_id.clone(),
            last_seen: p.last_seen,
            added: p.added,
            capabilities: clanker_tui_types::PeerCapabilitiesView {
