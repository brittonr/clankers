...
mod tests {
    ...
    fn restore_display_blocks_preserves_started_at_and_finalized_hash() {
        ...
        let mut app = App::new("test".to_string(), "/tmp".to_string(), crate::tui_config::detect_theme());
    ...
    fn restore_display_blocks_does_not_stamp_wall_clock_rebuild_time() {
        let mut first_app = App::new("test".to_string(), "/tmp".to_string(), crate::tui_config::detect_theme());
        let mut second_app = App::new("test".to_string(), "/tmp".to_string(), crate::tui_config::detect_theme());
        let messages = make_messages();
